...
// ── Pagination ────────────────────────────────────────────────────────────────
const currentPage = computed(() => props.cities?.current_page ?? 1)
const lastPage = computed(() => props.cities?.last_page ?? 1)
const cityList = computed(() => props.cities?.data ?? [])
</script>

<template>
    <AdminLayout :title="t('cities.title')">
        <div class="space-y-4">
            <!-- Header -->
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    >
                                        <span
                                            :class="city.is_active ? 'bg-green-500 dark:bg-green-400' : 'bg-red-400'"
