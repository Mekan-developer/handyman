    ...
    <Modal :show="show" max-width="md" @close="emit('close')">
        <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4 dark:border-slate-700">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white">
                {{ editing ? t('oblasts.edit') : t('oblasts.add') }}
            </h2>
            <button
                type="button"
                @click="emit('close')"
        ...
        <form @submit.prevent="emit('submit')">
            <div class="space-y-4 px-6 py-5">
                ...
                <div>
                    ...
                    <input
                        v-model="form.name"
                        type="text"
                        :placeholder="t('oblasts.name_placeholder')"
                        autofocus
                ...
                <div>
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            >
                                {{ form.is_active ? t('oblasts.active') : t('oblasts.inactive') }}
                            </span>
                        </div>
                        <div
            ...
            <div class="flex justify-end gap-2 border-t border-gray-100 px-6 py-4 dark:border-slate-700">
                ...
                >
                    {{ form.processing ? '...' : t('oblasts.save') }}
                </button>
            </div>
        </form>
    </Modal>
